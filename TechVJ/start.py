...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("❣️ Developer", url = "https://t.me/lakki_reddy3")
    ],[
        InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/lakki_redsy3'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/lakki_reddy3')
    ]]
